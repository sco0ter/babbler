 ...
 *
 * <p>It is shared by different connection methods: TCP socket, BOSH and WebSocket, which all have different ways to open a session
 * (initial stream header for socket connection, session creation request for BOSH, open frame for WebSockets).</p>
 *
